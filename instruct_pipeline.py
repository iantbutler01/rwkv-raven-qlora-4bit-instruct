...
import numpy as np
from transformers import Pipeline, PreTrainedTokenizer, LogitsProcessor, LogitsProcessorList
...
class InstructionTextGenerationPipeline(Pipeline):
    def __init__(
        self, *args, do_sample: bool = True, max_new_tokens: int = 256, top_p: float = 1.0, top_k=50, **kwargs
    ):
